...
public class ContactCreationTests extends TestBase {
  ...
  public void testContactCreationTests() throws Exception {
    ...
    ContactData contact = new ContactData()
            .withUsername("Asya1").withFamilyName("KasKas").withPhoto(photo).withAddress("test address").withPhoneNumber("+7 495 111 11 11").withEmail("asya.kasimova@something.ru");
